        ...
        ` : k.outstanding.map(c => {
          ...
          return html`
            <div class="ov-behalf-row">
              ...
              ${c.task_type === "checklist" ? html`<span class="muted">${this._t('common.checklist_use_child_card')}</span>` : html`<button class="btn good sm" ?disabled="${loading}"
              ...
              ` : outstanding.map(c => {
                ...
                return html`
                  <div class="tm-outstanding-row">
                    ...
                    ${c.task_type === "checklist" ? html`<span class="tm-outstanding-name">${this._t('common.checklist_use_child_card')}</span>` : html`<button class="btn-complete-behalf" ?disabled="${loading}"
